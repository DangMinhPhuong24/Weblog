    ...
    <div class="container">
        ...
        <div class="">
            <div class=" col-md-7 row2">
                ...
                <form >
                    @csrf
                    <input type="text" name="search_follow" placeholder="Tìm kiếm">
                                        ...
                                        <tr class="inner-box">
                                            <th scope="row">
                                                <div class="event-date">
                                                    <a href="profile/{{ $item->user_id }}" role="button">{{ $item->userFollow->name }}</a>
                                                </div>
                                            </th>
                                            
                                            <td>
                                                <div class="primary-btn">
                                                    <form action="/follows/{{ $item->id }}" method="POST">
                                                        @csrf
                                                        @method('delete')
