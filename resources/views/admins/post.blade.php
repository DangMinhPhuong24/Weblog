...
.event-schedule-area-two .tab-content .table tbody tr td .r-no .text-cho h1{
...
.event-schedule-area-two .tab-content .table tbody tr td .r-no .text-pheduyet h1{
    border: 1px solid black;
...
.event-schedule-area-two .tab-content .table tbody tr td .r-no .text-tuchoi h1{
    border: 1px solid black;
    background-color: red;
    border-radius: 20px;
    font-size: 20px;
            ...
            <div class=" col-md-7 row2">
                ...
                <form>
                    ...
                    <select name="filter" id="filter">
                        ...
                        <option value="{{ Request::url() }}?filter_by=da_phe_duyet">Đã phê duyệt</option>
                        <option value="{{ Request::url() }}?filter_by=cho_phe_duyet">Chờ phê duyệt</option>
                        <option value="{{ Request::url() }}?filter_by=da_tu_choi">Đã từ chối</option>
                    </select>
                </form>

                <form >
                    @csrf
                    <input type="text" name="search_post" placeholder="Tìm kiếm">
                    ...
                    <div class="tab-pane fade active show" id="home" role="tabpanel">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="text-center" scope="col">Bài viết</th>
                                        <th scope="col">Ảnh</th>
                                        <th scope="col">Nội dung</th>
                                        <th scope="col">Trạng thái</th>
                                        <th class="text-center" scope="col">Tuỳ chỉnh</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr class="inner-box">
                                            <th scope="row">
                                                <div class="event-date">
                                                    <a href="posts/{{ $item->id }}" role="button">{{ $item->name }}</a>
                                                </div>
                                            </th>
                                            <td>
                                                <div class="event-img">
                                                ...
                                                <div class="r-no ">
                                                    <span>
                                                        ...
                                                        @elseif($item->status == 1)
                                                            <div class="text-pheduyet">
                                                                <h1>đã phê duyệt</h1>
                                                            </div>
                                                        @else
                                                            <div class="text-tuchoi">
                                                                <h1>đã bị từ chối</h1>
                                                            </div>
                                                        @endif
                                            ...
                                            <td>
                                                <div class="primary-btn">
                                                    <a class="btn btn-primary" href="posts/{{ $item->id }}/edit">Sửa</a>
