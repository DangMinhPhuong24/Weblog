...
@section('content')
<h1>Danh sách bài viết chưa được phê duyệt </h1>
    ...
    <div class="container">
        ...
        <div class="">
            <div class=" col-md-7 row2">
                ...
                <form >
                    @csrf
                    <input type="text" name="search_approve" placeholder="Tìm kiếm">
                                    ...
                                    <tr class="inner-box">
                                        <th scope="row">
                                            <div class="event-date">
                                                ...
                                                <a href="{{ url('approve',$item->id) }}" role="button">{{ $item->name }}</a>
                                            </div>
                                        </th>
                                        <td>
                                            <div class="event-img">
                                        ...
                                        <td>
                                            <div class="primary-btn">
                                                <a onclick="return confirm('bạn muốn phê duyệt bài viết này chứ?')" class="btn btn-primary" href="{{ url('accept_post',$item->id) }}">
                                                    Phê duyệt
                                                </a>
                                                <a onclick="return confirm('bạn muốn từ chối bài viết này chứ?')" class="btn btn-danger" href="{{ url('reject_post',$item->id) }}">
                                                    Từ chối                                                   
                                                </a>
                                            </div>
                                        </td>
